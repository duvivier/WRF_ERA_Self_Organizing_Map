...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/'$datatitle1'-vs-'$datatitle1b'/group_fluxes/'
...
##############
   ...
   ncl 'datatitle1         = "'$datatitle1'"' \
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_groups_avgs_compare.ncl
