...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/flux_compare/flux_6h_node/'$datatitle1'/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_flux_6h_node_compare.ncl
