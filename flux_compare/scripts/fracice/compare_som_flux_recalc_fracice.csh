...
set varcode  = ( 'LH' 'SH' 'LH_frac' 'SH_frac' )
...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/flux_compare/flux_recalc_fracice/'$datatitle1'-and-'$datatitle1b'/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_flux_recalc_compare_fracice.ncl
