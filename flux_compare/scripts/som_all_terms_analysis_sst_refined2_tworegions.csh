...
set varcode  = ('LH' 'SH' 'TurbFlx' 'Tgrad' 'T_2m' 'T_sfc' 'qgrad' 'q_2m' 'q_sfc' 'U10' 'curltau')
...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/'$datatitle1'-vs-'$datatitle1b'/fluxes-sst-refined-tworegions-case'$type'/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_diff_all_terms_fluxes_sst_refined2_tworegions.ncl
