...
set varcode  = ( 'LH' 'SH' 'TurbFlx' 'Tgrad' 'qgrad')
...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/'$datatitle1'-vs-'$datatitle1b'/fluxes-case'$type'/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_diff_all_terms_fluxes.ncl
