...
set varcode  = ('LH' 'SH' 'TurbFlx' 'Tgrad' 'T_2m' 'T_sfc' 'qgrad' 'q_2m' 'q_sfc' 'U10')
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/flux_compare/som_node_contributions_sst.ncl
