...
set varcode = ('LH' 'SH' 'precip_tot' 'SLP_anom')

#set varcode  = ('U10_speed' 'U10_field' 'SLP_anom' \
#		 'T_sfc' 'T_2m' 'q_2m' \
#                 'LH' 'SH' 'TurbFlx' \
#                 'SWUS' 'SWDS' 'LWUS' 'LWDS' \
...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/'$datatitle1'-vs-'$datatitle1b'/standard/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/why_avg_diffs/som_node_contributions.ncl
