...
##############
    ...
    set fname0 = $dir_in'wrf-'$y0'-11.wrf_standalone-cf.nc'
    set fname1 = $dir_in'wrf-'$y0'-12.wrf_standalone-cf.nc'
    set fname2 = $dir_in'wrf-'$yy'-01.wrf_standalone-cf.nc'
    set fname3 = $dir_in'wrf-'$yy'-02.wrf_standalone-cf.nc'
    set fname4 = $dir_in'wrf-'$yy'-03.wrf_standalone-cf.nc'
