...
set outdir = $maindir'analysis/figures/'$nx_input'x_'$ny_input'y/'$datatitle1'-vs-'$datatitle1b'/extremes-sst/'
...
##############
   ...
   ncl 'nx_input           = "'$nx_input'"'\
       ...
       'varcode            = "'$varcode[$q]'"' \
       /data3/duvivier/SOM/analysis/extremes/som_extremes_fluxes_sst.ncl
